 ...
 */
package neal.http.impl.httpstack;
...
import neal.http.base.Request.Method;
import neal.http.impl.HttpErrorCollection;

/**
 * An {@link neal.http.base.HttpStack} based on {@link java.net.HttpURLConnection}.
 * 网络处理的核心类，
 * 2.3以及之后建议使用此类
 */
public class HurlStack implements HttpStack {
    ...
    /* package */ static void setConnectionParametersForRequest(HttpURLConnection connection,
            Request<?> request) throws IOException, HttpErrorCollection.AuthFailureError {
