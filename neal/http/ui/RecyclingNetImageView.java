...
public class RecyclingNetImageView extends RecyclingImageView {
     ...
     * {@link neal.http.ui.RecyclingNetImageView#setDefaultImageResId(int)} on the view.
     *
     * NOTE: If applicable, {@link neal.http.ui.RecyclingNetImageView#setDefaultImageResId(int)} and
     * {@link neal.http.ui.RecyclingNetImageView#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
    ...
    public void setImageUrl(String url,ImageLoader imageLoader,Drawable defaultDrawable, Drawable errorDrawable){
        mUrl = url;
        if(null==imageLoader){
            imageLoader= Http.getImageLoader(mContext.getApplicationContext());
        }
    ...
    public void setImageUrl(String url,Drawable defaultDrawable, Drawable errorDrawable){
        setImageUrl(url,null,defaultDrawable,errorDrawable);
    }
